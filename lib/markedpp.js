 ...
 * @return {String} rendered output
 */
Renderer.prototype.code = function(code, lang, indent, fences) {
	return this.fences(lang, indent, fences) + code + '\n' + this.fences('', indent, fences);
};
 ...
 */
Renderer.prototype.fences = function(lang, indent, fences) {
  fences = fences || '```';
  indent = indent || '';
